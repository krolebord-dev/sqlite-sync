/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a225ad390f0e628ea4a06d69bd6b9703)
// Runtime types generated with workerd@1.20260120.0 2025-12-02 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/event-log-server");
		durableNamespaces: "EventLogServer";
	}
	interface Env {
		EventLogServer: DurableObjectNamespace<import("./src/server/event-log-server").EventLogServer>;
	}
}
