/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2096685a7b558a064427d25980d4761e)
// Runtime types generated with workerd@1.20260120.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "UserDbServer";
	}
	interface Env {
		MAIN_DB: D1Database;
		MODE: "development";
		...
		VITE_APP_URL: string;
		UserDbServer: DurableObjectNamespace<import("./src/server").UserDbServer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "VITE_APP_URL">> {}
}
