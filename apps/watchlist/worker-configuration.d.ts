/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b0cc6471efd069bd926a19d2e801379a)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ListDbServer" | "ChatAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "VITE_APP_URL" | "TMDB_READ_ACCESS_TOKEN" | "OPENROUTER_API_KEY">> {}
}
