/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c65f36fd282aefb9b986858375d68aa7)
// Runtime types generated with workerd@1.20251210.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ListDbServer";
	}
	interface Env {
		MODE: "production";
		AUTH_SECRET: string;
		...
		ListDbServer: DurableObjectNamespace<import("./src/server").ListDbServer>;
		MAIN_DB: D1Database;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "VITE_APP_URL" | "RESEND_API_KEY" | "TMDB_READ_ACCESS_TOKEN" | "OPENROUTER_API_KEY">> {}
}
